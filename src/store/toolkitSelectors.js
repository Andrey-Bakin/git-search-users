...
export const totalPagesFoundSelector = (store) => mainSelector(store).totalPagesFound
export const textInputSearchSelector = (store) => mainSelector(store).textInputSearch